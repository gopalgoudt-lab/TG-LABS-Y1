...
export async function POST(request:Request){
 try{
  ...
  const meta:ManualMeta={brand:'THYROCARE',billNumber:bill,tests:b.tests,grossAmount:b.totalAmount,discount:b.discount,paidAmount:b.paidAmount,balance,patient:snapshot,doctorName:b.doctorName,sampleEntryAt:now.toISOString(),paymentMode:b.paymentMode,paymentModes};
