...
export default function InsulinTestHyderabadPage() {
  return <main style={{ minHeight: '100vh', background: '#f5faf8', color: '#163b34', fontFamily: 'Arial,sans-serif' }}>
    ...
    <section style={{ maxWidth: 1180, margin: '0 auto 54px', padding: '0 22px' }}><div style={{ background: '#e8f5f1', borderRadius: 18, padding: 24, lineHeight: 1.65 }}><b>Availability and preparation notice</b><p>This discovery page does not guarantee a particular insulin test, partner, price, pincode or home collection slot. Confirm current test details, eligibility and preparation instructions shown for the selected test in the live TG Labs catalog before booking.</p><div style={{ display: 'flex', gap: 18, flexWrap: 'wrap' }}><a href="/fasting-blood-sugar-test-hyderabad">Explore FBS tests →</a><a href="/hba1c-test-hyderabad">Explore HbA1c tests →</a><a href="/glucose-tolerance-test-hyderabad">Explore GTT tests →</a></div></div></section>
  </main>;
}
