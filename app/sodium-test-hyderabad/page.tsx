...
export const metadata: Metadata = {
  title: { absolute: 'Serum Sodium Test in Hyderabad | TG Labs' },
  description: 'Explore serum sodium test options in Hyderabad through TG Labs. Current test details, partner eligibility, price, preparation and collection options depend on the live catalog and pincode.',
  alternates: { canonical: 'https://www.tglabs.in/sodium-test-hyderabad' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Serum Sodium Test in Hyderabad | TG Labs',
    description: 'Browse currently displayable serum sodium test options and confirm live test details, preparation, price, partner eligibility and collection availability before booking.',
    url: 'https://www.tglabs.in/sodium-test-hyderabad',
    type: 'website',
  },
};
...
const breadcrumbs = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Serum Sodium Test in Hyderabad', item: 'https://www.tglabs.in/sodium-test-hyderabad' },
  ],
};

export default function SodiumTestHyderabadPage() {
  return (
