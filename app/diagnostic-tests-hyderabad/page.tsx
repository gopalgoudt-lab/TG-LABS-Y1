...
export default function DiagnosticTestsHyderabadPage() {
  return (
    <main style={{ minHeight: '100vh', background: '#f5faf8', color: '#163b34', fontFamily: 'Arial,sans-serif' }}>
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto 54px', padding: '0 22px' }}><div style={{ background: '#e8f5f1', borderRadius: 18, padding: 24, lineHeight: 1.65 }}><b>Availability notice</b><p>This discovery page does not guarantee that every test, partner, slot or pincode is bookable. Use the live catalog and pincode check for current eligibility.</p><a href="/health-blog">Read TG Labs health guides →</a></div></section>
    </main>
  );
}
