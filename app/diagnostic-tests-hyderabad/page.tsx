...
export default function DiagnosticTestsHyderabadPage() {
  return (
    <main style={{ minHeight: '100vh', background: '#f5faf8', color: '#163b34', fontFamily: 'Arial,sans-serif' }}>
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto 54px', padding: '0 22px' }}><div style={{ background: '#e8f5f1', borderRadius: 18, padding: 24, lineHeight: 1.65 }}><b>Availability notice</b><p>This discovery page does not guarantee that every test, partner, slot or pincode is bookable. Use the live catalog and pincode check for current eligibility.</p><div style={{ display: 'flex', gap: 18, flexWrap: 'wrap' }}><a href="/thyroid-test-hyderabad">Explore thyroid test options →</a><a href="/tsh-test-hyderabad">Explore TSH test options →</a><a href="/t3-test-hyderabad">Explore T3 test options →</a><a href="/t4-test-hyderabad">Explore T4 test options →</a><a href="/diabetes-test-hyderabad">Explore diabetes test options →</a><a href="/hba1c-test-hyderabad">Explore HbA1c test options →</a><a href="/fasting-blood-sugar-test-hyderabad">Explore FBS test options →</a><a href="/cbc-test-hyderabad">Explore CBC test options →</a><a href="/vitamin-d-test-hyderabad">Explore Vitamin D test options →</a><a href="/vitamin-b12-test-hyderabad">Explore Vitamin B12 test options →</a><a href="/lipid-profile-test-hyderabad">Explore lipid profile test options →</a><a href="/liver-function-test-hyderabad">Explore liver function test options →</a><a href="/kidney-function-test-hyderabad">Explore kidney function test options →</a><a href="/home-blood-test-hyderabad">Explore home blood test options →</a><a href="/health-blog">Read TG Labs health guides →</a></div></div></section>
    </main>
  );
}
