    ...
    return (
      <main className="dashboard">
        <div className="card flowCard">
          ...
          <p>Your booking has been saved successfully. Payment remains pending until the Razorpay integration is activated.</p>
          <div className="notice">
            ...
            <b>Amount:</b> ₹{total.toLocaleString('en-IN')}
          </div>
          <a className="btn primary" href="/">Return to TG Labs →</a>
        </div>
      </main>
    );
  }
