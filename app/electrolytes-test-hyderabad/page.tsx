...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Serum Electrolytes Test in Hyderabad | TG Labs',
    description: 'Browse currently displayable serum electrolytes test options and confirm live components, preparation, price, partner eligibility and collection availability before booking.',
    url: 'https://www.tglabs.in/electrolytes-test-hyderabad',
    type: 'website',
  },
};
