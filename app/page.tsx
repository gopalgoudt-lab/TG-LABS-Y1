...
export default function Home(){
  ...
  return <>
    ...
    <header className="marketHeader"><div className="marketWrap marketNav">
      <a className="marketBrand" href="/" aria-label="TG Labs home"><strong>TG LABS</strong><small>TRUSTED • ACCURATE • TRANSPARENT</small></a>
