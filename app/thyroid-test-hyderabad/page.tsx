...
export const metadata: Metadata = {
  title: 'Thyroid Test in Hyderabad',
  description: 'Explore thyroid blood test and thyroid profile options in Hyderabad through TG Labs. Test availability, partner eligibility, price and home collection depend on the live catalog and pincode.',
  alternates: { canonical: 'https://www.tglabs.in/thyroid-test-hyderabad' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Thyroid Test in Hyderabad | TG Labs',
    description: 'Browse currently displayable thyroid test and profile options, compare eligible partner labs, and confirm live price and home collection availability before booking.',
...
const cards = [
  ['Search thyroid tests and profiles', 'Use the live TG Labs catalog to find currently displayable thyroid-related tests and profiles before choosing an option.'],
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#f5faf8', color: '#163b34', fontFamily: 'Arial,sans-serif' }}>
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto', padding: '42px 22px 28px' }}>
        ...
        <h1 style={{ fontSize: 'clamp(34px,5vw,56px)', lineHeight: 1.05 }}>Thyroid tests and thyroid profiles in Hyderabad.</h1>
        <p style={{ maxWidth: 860, fontSize: 18, lineHeight: 1.7, color: '#536b65' }}>Browse thyroid-related tests and profiles in the live TG Labs catalog, compare currently displayable partner options, and confirm current pricing and home collection eligibility before booking.</p>
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto 54px', padding: '0 22px' }}>
        <div style={{ background: '#e8f5f1', borderRadius: 18, padding: 24, lineHeight: 1.65 }}><b>Test information notice</b><p>This discovery page does not guarantee a particular thyroid test, profile, partner, price, pincode or home collection slot. Confirm the current test details, offer information and eligibility in the live TG Labs catalog and booking flow.</p><div style={{ display: 'flex', gap: 18, flexWrap: 'wrap' }}><a href="/health-blog/thyroid-profile-test-guide">Read the thyroid profile guide →</a><a href="/home-blood-test-hyderabad">Check home collection options →</a></div></div>
      </section>
    </main>
  );
}
