...
ALTER TABLE "DiagnosticPackage"
  ADD COLUMN "catalogCode" TEXT,
  ADD COLUMN "packageType" "DiagnosticPackageType",
  ADD COLUMN "aliases" TEXT[] NOT NULL DEFAULT ARRAY[]::TEXT[],
  ADD COLUMN "preparation" TEXT,
  ADD COLUMN "fastingHours" INTEGER,
  ADD COLUMN "parameterCount" INTEGER,
...
CREATE INDEX "PartnerServiceability_pincode_active_homeCollectionEnabled_idx" ON "PartnerServiceability"("pincode", "active", "homeCollectionEnabled");
CREATE INDEX "PartnerServiceability_partnerId_active_idx" ON "PartnerServiceability"("partnerId", "active");
