...
export default function CatalogDetail({product}:{product:Product}){
 ...
 return <main className="testDetailPage">
  ...
  {detailsImage ? <a className="testDetailsImageLink" href={detailsImage} target="_blank" rel="noreferrer">View test details</a> : null}</div>
